...
PairStyle(msucg_neigh_multi,PairMSUCG_NEIGH_MULTI)

#else

#ifndef LMP_PAIR_MSUCG_NEIGH_MULTI_H
#define LMP_PAIR_MSUCG_NEIGH_MULTI_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_NEIGH_MULTI : public Pair {
 public:
  PairMSUCG_NEIGH_MULTI(class LAMMPS *);
  virtual ~PairMSUCG_NEIGH_MULTI();
