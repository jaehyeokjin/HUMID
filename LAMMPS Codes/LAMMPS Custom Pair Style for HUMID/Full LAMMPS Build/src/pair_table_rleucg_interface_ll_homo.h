...
PairStyle(table_rleucg_interface_ll_homo,PairTable_RLEUCG_INTERFACE_LL_HOMO)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_HOMO_H
#define LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_HOMO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_INTERFACE_LL_HOMO : public Pair {
 public:
  PairTable_RLEUCG_INTERFACE_LL_HOMO(class LAMMPS *);
  virtual ~PairTable_RLEUCG_INTERFACE_LL_HOMO();
