...
PairMSUCG_NEIGHF::PairMSUCG_NEIGHF(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
...
PairMSUCG_NEIGHF::~PairMSUCG_NEIGHF()
{
  if (allocated) {
...
double PairMSUCG_NEIGHF::P(int type, int state, double *x, double *f, double w, double *uval)
{
...
int PairMSUCG_NEIGHF::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGHF::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairMSUCG_NEIGHF::pack_forward_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void PairMSUCG_NEIGHF::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGHF::compute(int eflag, int vflag)
{
...
void PairMSUCG_NEIGHF::compute_inner()
{
...
void PairMSUCG_NEIGHF::compute_middle()
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGHF::compute_outer(int eflag, int vflag)
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGHF::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairMSUCG_NEIGHF::settings(int narg, char **arg)
{
...
void PairMSUCG_NEIGHF::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
void PairMSUCG_NEIGHF::init_style()
{
...
void PairMSUCG_NEIGHF::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairMSUCG_NEIGHF::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairMSUCG_NEIGHF::write_restart(FILE *fp)
{
...
void PairMSUCG_NEIGHF::read_restart(FILE *fp)
{
...
void PairMSUCG_NEIGHF::write_restart_settings(FILE *fp)
{
...
void PairMSUCG_NEIGHF::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairMSUCG_NEIGHF::write_data(FILE *fp)
{
...
void PairMSUCG_NEIGHF::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairMSUCG_NEIGHF::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairMSUCG_NEIGHF::extract(const char *str, int &dim)
{
  dim = 2;
