...
PairStyle(msucg_neighf,PairMSUCG_NEIGHF)

#else

#ifndef LMP_PAIR_MSUCG_NEIGHF_H
#define LMP_PAIR_MSUCG_NEIGHF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_NEIGHF : public Pair {
 public:
  PairMSUCG_NEIGHF(class LAMMPS *);
  virtual ~PairMSUCG_NEIGHF();
