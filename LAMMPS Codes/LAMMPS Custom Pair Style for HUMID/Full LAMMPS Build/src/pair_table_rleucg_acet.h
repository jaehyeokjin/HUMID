...
PairStyle(table_rleucg_acet,PairTable_RLEUCG_ACET)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_ACET_H
#define LMP_PAIR_TABLE_RLEUCG_ACET_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_ACET : public Pair {
 public:
  PairTable_RLEUCG_ACET(class LAMMPS *);
  virtual ~PairTable_RLEUCG_ACET();
