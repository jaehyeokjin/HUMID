...
PairStyle(msucg_mix1d,PairMSUCG_MIX1D)

#else

#ifndef LMP_PAIR_MSUCG_MIX1D_H
#define LMP_PAIR_MSUCG_MIX1D_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_MIX1D : public Pair {
 public:
  PairMSUCG_MIX1D(class LAMMPS *);
  virtual ~PairMSUCG_MIX1D();
