...
PairStyle(table_rleucg_ll,PairTable_RLEUCG_LL)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_LL_H
#define LMP_PAIR_TABLE_RLEUCG_LL_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_LL : public Pair {
 public:
  PairTable_RLEUCG_LL(class LAMMPS *);
  virtual ~PairTable_RLEUCG_LL();
