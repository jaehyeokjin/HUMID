...
PairStyle(table_ucg_hydronium_cnt,PairTable_UCG_HYDRONIUM_CNT)

#else

#ifndef LMP_PAIR_TABLE_UCG_HYDRONIUM_CNT_H
#define LMP_PAIR_TABLE_UCG_HYDRONIUM_CNT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_UCG_HYDRONIUM_CNT : public Pair {
 public:
  PairTable_UCG_HYDRONIUM_CNT(class LAMMPS *);
  virtual ~PairTable_UCG_HYDRONIUM_CNT();
