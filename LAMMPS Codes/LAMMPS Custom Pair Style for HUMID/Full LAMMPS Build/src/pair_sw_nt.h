...
PairStyle(sw_nt,PairSW_NT)

#else

#ifndef LMP_PAIR_SW_NT_H
#define LMP_PAIR_SW_NT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSW_NT : public Pair {
 public:
  PairSW_NT(class LAMMPS *);
  virtual ~PairSW_NT();
 ...
 protected:
  ...
  void threebody2(Param *, Param *, Param *, double, double, double *, double *,
                 double *, double *, int, double &);
};
