...
PairMSUCG_NEIGH_MULTI_ISO::PairMSUCG_NEIGH_MULTI_ISO(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
  countiter = 0;
...
PairMSUCG_NEIGH_MULTI_ISO::~PairMSUCG_NEIGH_MULTI_ISO()
{
  if (allocated) {
...
double PairMSUCG_NEIGH_MULTI_ISO::P(int type, int state, double *x, double *f, double w, double *uval, int single)
{
    ...
    else if(type != 1 || state == 3)
    {
      error->one(FLERR,"State 3 is not in the switching");
    }
...
int PairMSUCG_NEIGH_MULTI_ISO::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGH_MULTI_ISO::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairMSUCG_NEIGH_MULTI_ISO::pack_forward_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void PairMSUCG_NEIGH_MULTI_ISO::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGH_MULTI_ISO::compute(int eflag, int vflag)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::compute_inner()
{
...
void PairMSUCG_NEIGH_MULTI_ISO::compute_middle()
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGH_MULTI_ISO::compute_outer(int eflag, int vflag)
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGH_MULTI_ISO::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairMSUCG_NEIGH_MULTI_ISO::settings(int narg, char **arg)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
void PairMSUCG_NEIGH_MULTI_ISO::init_style()
{
...
void PairMSUCG_NEIGH_MULTI_ISO::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairMSUCG_NEIGH_MULTI_ISO::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairMSUCG_NEIGH_MULTI_ISO::write_restart(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::read_restart(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::write_restart_settings(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairMSUCG_NEIGH_MULTI_ISO::write_data(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI_ISO::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairMSUCG_NEIGH_MULTI_ISO::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairMSUCG_NEIGH_MULTI_ISO::extract(const char *str, int &dim)
{
  dim = 2;
