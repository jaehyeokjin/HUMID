...
PairStyle(msucg_neigh_hetero,PairMSUCG_NEIGH_HETERO)

#else

#ifndef LMP_PAIR_MSUCG_NEIGH_HETERO_H
#define LMP_PAIR_MSUCG_NEIGH_HETERO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_NEIGH_HETERO : public Pair {
 public:
  PairMSUCG_NEIGH_HETERO(class LAMMPS *);
  virtual ~PairMSUCG_NEIGH_HETERO();
