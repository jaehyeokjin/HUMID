...
PairStyle(table_rleucg_thiol,PairTable_RLEUCG_THIOL)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_THIOL_H
#define LMP_PAIR_TABLE_RLEUCG_THIOL_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_THIOL : public Pair {
 public:
  PairTable_RLEUCG_THIOL(class LAMMPS *);
  virtual ~PairTable_RLEUCG_THIOL();
