...
PairStyle(table_check,PairTable_CHECK)

#else

#ifndef LMP_PAIR_TABLE_CHECK_H
#define LMP_PAIR_TABLE_CHECK_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_CHECK : public Pair {
 public:
  PairTable_CHECK(class LAMMPS *);
  virtual ~PairTable_CHECK();
