...
PairStyle(table_rleucg_wat,PairTable_RLEUCG_WAT)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_WAT_H
#define LMP_PAIR_TABLE_RLEUCG_WAT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_WAT : public Pair {
 public:
  PairTable_RLEUCG_WAT(class LAMMPS *);
  virtual ~PairTable_RLEUCG_WAT();
 ...
 protected:
  ...
  // RLEUCG_WAT functions and variables
