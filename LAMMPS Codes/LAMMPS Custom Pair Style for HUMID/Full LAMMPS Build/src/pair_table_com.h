...
PairStyle(table_com,PairTable_com)

#else

#ifndef LMP_PAIR_TABLE_COM_H
#define LMP_PAIR_TABLE_COM_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_com : public Pair {
 public:
  PairTable_com(class LAMMPS *);
  virtual ~PairTable_com();
