...
PairStyle(table_rleucg_amine,PairTable_RLEUCG_AMINE)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_AMINE_H
#define LMP_PAIR_TABLE_RLEUCG_AMINE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_AMINE : public Pair {
 public:
  PairTable_RLEUCG_AMINE(class LAMMPS *);
  virtual ~PairTable_RLEUCG_AMINE();
