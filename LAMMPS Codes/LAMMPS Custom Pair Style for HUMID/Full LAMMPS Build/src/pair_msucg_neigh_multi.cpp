...
PairMSUCG_NEIGH_MULTI::PairMSUCG_NEIGH_MULTI(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
  countiter = 0;
...
PairMSUCG_NEIGH_MULTI::~PairMSUCG_NEIGH_MULTI()
{
  if (allocated) {
...
double PairMSUCG_NEIGH_MULTI::P(int type, int state, double *x, double *f, double w, double *uval, int single)
{
...
int PairMSUCG_NEIGH_MULTI::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGH_MULTI::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairMSUCG_NEIGH_MULTI::pack_forward_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void PairMSUCG_NEIGH_MULTI::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGH_MULTI::compute(int eflag, int vflag)
{
...
void PairMSUCG_NEIGH_MULTI::compute_inner()
{
...
void PairMSUCG_NEIGH_MULTI::compute_middle()
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGH_MULTI::compute_outer(int eflag, int vflag)
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGH_MULTI::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairMSUCG_NEIGH_MULTI::settings(int narg, char **arg)
{
...
void PairMSUCG_NEIGH_MULTI::coeff(int narg, char **arg)
{
  if (narg < 5 || narg > 6)
...
void PairMSUCG_NEIGH_MULTI::init_style()
{
...
void PairMSUCG_NEIGH_MULTI::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairMSUCG_NEIGH_MULTI::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairMSUCG_NEIGH_MULTI::write_restart(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI::read_restart(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI::write_restart_settings(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairMSUCG_NEIGH_MULTI::write_data(FILE *fp)
{
...
void PairMSUCG_NEIGH_MULTI::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairMSUCG_NEIGH_MULTI::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairMSUCG_NEIGH_MULTI::extract(const char *str, int &dim)
{
  dim = 2;
