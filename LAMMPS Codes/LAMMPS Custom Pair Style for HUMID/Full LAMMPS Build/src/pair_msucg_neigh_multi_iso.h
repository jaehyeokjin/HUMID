...
PairStyle(msucg_neigh_multi_iso,PairMSUCG_NEIGH_MULTI_ISO)

#else

#ifndef LMP_PAIR_MSUCG_NEIGH_MULTI_ISO_H
#define LMP_PAIR_MSUCG_NEIGH_MULTI_ISO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_NEIGH_MULTI_ISO : public Pair {
 public:
  PairMSUCG_NEIGH_MULTI_ISO(class LAMMPS *);
  virtual ~PairMSUCG_NEIGH_MULTI_ISO();
