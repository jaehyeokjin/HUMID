...
PairStyle(table_rleucg_prev,PairTable_RLEUCG_PREV)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_PREV_H
#define LMP_PAIR_TABLE_RLEUCG_PREV_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_PREV : public Pair {
 public:
  PairTable_RLEUCG_PREV(class LAMMPS *);
  virtual ~PairTable_RLEUCG_PREV();
