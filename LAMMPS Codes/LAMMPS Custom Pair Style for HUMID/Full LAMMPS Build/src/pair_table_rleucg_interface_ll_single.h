...
PairStyle(table_rleucg_interface_ll_single,PairTable_RLEUCG_INTERFACE_LL_SINGLE)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_SINGLE_H
#define LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_SINGLE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_INTERFACE_LL_SINGLE : public Pair {
 public:
  PairTable_RLEUCG_INTERFACE_LL_SINGLE(class LAMMPS *);
  virtual ~PairTable_RLEUCG_INTERFACE_LL_SINGLE();
