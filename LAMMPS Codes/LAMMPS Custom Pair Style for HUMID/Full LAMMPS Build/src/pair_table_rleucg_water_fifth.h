...
PairStyle(table_rleucg_water_fifth,PairTable_RLEUCG_WATER_FIFTH)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_WATER_FIFTH_H
#define LMP_PAIR_TABLE_RLEUCG_WATER_FIFTH_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_WATER_FIFTH : public Pair {
 public:
  PairTable_RLEUCG_WATER_FIFTH(class LAMMPS *);
  virtual ~PairTable_RLEUCG_WATER_FIFTH();
