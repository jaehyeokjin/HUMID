...
PairTable_RLEUCG::PairTable_RLEUCG(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
  // From PAIR_RLEUCG_NEIGH
  nmax = 0;
...
PairTable_RLEUCG::~PairTable_RLEUCG()
{
...
void PairTable_RLEUCG::threshold_prob_and_partial_from_cv(int type, double cv, double &prob, double &partial) 
{
  if (type == 2){
...
int PairTable_RLEUCG::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairTable_RLEUCG::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairTable_RLEUCG::pack_forward_comm(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
  int i,j,m,jsubstate;
...
void PairTable_RLEUCG::unpack_forward_comm(int n, int first, double *buf)
{
...
double PairTable_RLEUCG::compute_proximity_function(int type, double distance) {
  double tanh_factor = tanh((distance - threshold_radii[type]) / (0.1 * threshold_radii[type]));
  return 0.5 * (1.0 - tanh_factor);
}

double PairTable_RLEUCG::compute_proximity_function_der(int type, double distance) {
  double tanh_factor = tanh((distance - threshold_radii[type]) / (0.1 * threshold_radii[type]));
...
void PairTable_RLEUCG::compute(int eflag, int vflag)
{
...
void PairTable_RLEUCG::allocate()
{
  allocated = 1;
...
void PairTable_RLEUCG::settings(int narg, char **arg)
{
...
void PairTable_RLEUCG::read_state_settings(const char *file) {
  char *eof;
  char line[MAXLINE];
...
void PairTable_RLEUCG::coeff(int narg, char **arg)
{
...
void PairTable_RLEUCG::init_style()
{
...
double PairTable_RLEUCG::init_one(int i, int j)
{
...
void PairTable_RLEUCG::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairTable_RLEUCG::bcast_table(Table *tb)
{
...
void PairTable_RLEUCG::spline_table(Table *tb)
{
...
void PairTable_RLEUCG::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairTable_RLEUCG::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairTable_RLEUCG::null_table(Table *tb)
{
...
void PairTable_RLEUCG::free_table(Table *tb)
{
...
void PairTable_RLEUCG::spline(double *x, double *y, int n,
...
double PairTable_RLEUCG::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairTable_RLEUCG::write_restart(FILE *fp)
{
...
void PairTable_RLEUCG::read_restart(FILE *fp)
{
...
void PairTable_RLEUCG::write_restart_settings(FILE *fp)
{
...
void PairTable_RLEUCG::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairTable_RLEUCG::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairTable_RLEUCG::extract(const char *str, int &dim)
{
