...
PairStyle(sw_double,PairSW_Double)

#else

#ifndef LMP_PAIR_SW_DOUBLE_H
#define LMP_PAIR_SW_DOUBLE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSW_Double : public Pair {
 public:
  PairSW_Double(class LAMMPS *);
  virtual ~PairSW_Double();
