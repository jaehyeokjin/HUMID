...
PairStyle(msucg_neighck,PairMSUCG_NEIGHCK)

#else

#ifndef LMP_PAIR_MSUCG_NEIGHCK_H
#define LMP_PAIR_MSUCG_NEIGHCK_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_NEIGHCK : public Pair {
 public:
  PairMSUCG_NEIGHCK(class LAMMPS *);
  virtual ~PairMSUCG_NEIGHCK();
