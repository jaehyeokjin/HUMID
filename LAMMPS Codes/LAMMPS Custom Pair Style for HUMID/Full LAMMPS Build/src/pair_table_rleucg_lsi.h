...
PairStyle(table_rleucg_lsi,PairTable_RLEUCG_LSI)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_LSI_H
#define LMP_PAIR_TABLE_RLEUCG_LSI_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_LSI : public Pair {
 public:
  PairTable_RLEUCG_LSI(class LAMMPS *);
  virtual ~PairTable_RLEUCG_LSI();
 ...
 protected:
  ...
  // RLEUCG_LSI functions and variables
