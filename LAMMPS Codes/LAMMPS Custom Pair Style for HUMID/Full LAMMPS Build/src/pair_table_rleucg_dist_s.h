...
PairStyle(table_rleucg_dist_s,PairTable_RLEUCG_DIST_S)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_DIST_S_H
#define LMP_PAIR_TABLE_RLEUCG_DIST_S_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_DIST_S : public Pair {
 public:
  PairTable_RLEUCG_DIST_S(class LAMMPS *);
  virtual ~PairTable_RLEUCG_DIST_S();
