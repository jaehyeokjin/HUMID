...
PairStyle(table_msucgtwo,PairTable_MSUCGTWO)

#else

#ifndef LMP_PAIR_TABLE_MSUCGTWO_H
#define LMP_PAIR_TABLE_MSUCGTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_MSUCGTWO : public Pair {
 public:
  PairTable_MSUCGTWO(class LAMMPS *);
  virtual ~PairTable_MSUCGTWO();
 ...
 protected:
  ...
  // MSUCGTWO functions and variables
