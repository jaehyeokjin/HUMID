...
PairSW_Double::PairSW_Double(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
  restartinfo = 0;
  one_coeff = 1;
...
void PairSW_Double::compute(int eflag, int vflag)
{
...
*/
    ...
    for (jj = 0; jj < jnumm1; jj++) {
      ...
      for (kk = jj+1; kk < jnum; kk++) {
        ...
        if (rsq2 > params[ikparam].cutsq*0.25) continue;
...
void PairSW_Double::settings(int narg, char **arg)
{
...
void PairSW_Double::coeff(int narg, char **arg)
{
  int i,j,n;
...
double PairSW_Double::init_one(int i, int j)
{
...
void PairSW_Double::read_file(char *file)
{
...
void PairSW_Double::twobody(Param *param, double rsq, double &fforce,
...
void PairSW_Double::threebody(Param *paramij, Param *paramik, Param *paramijk,
