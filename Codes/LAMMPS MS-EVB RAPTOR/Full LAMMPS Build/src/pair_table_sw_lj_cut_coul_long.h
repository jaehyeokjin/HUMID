...
PairStyle(table/sw/lj/cut/coul/long,PairTableSWLJCutCoulLong)

#else

#ifndef LMP_PAIR_TABLE_SW_LJ_CUT_COUL_LONG_H
#define LMP_PAIR_TABLE_SW_LJ_CUT_COUL_LONG_H

#include "pair.h"

namespace LAMMPS_NS {

  class PairTableSWLJCutCoulLong : public Pair {
  public:
    PairTableSWLJCutCoulLong(class LAMMPS *); 
    virtual ~PairTableSWLJCutCoulLong();
  ...
  public:
    ...
    virtual double single_tab_ener(int, int, int, int, double, double);
    virtual double single_tab_fpair(int, int, int, int, double, double);
    
  protected:

    // SW declarations
    double **sw_scale_epsilon;
    double **sw_scale_biga;
    double **sw_scale_lambda;
