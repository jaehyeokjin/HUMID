...
PairStyle(table_orientation,PairTable_Orientation)

#else

#ifndef LMP_PAIR_TABLE_Orientation_H
#define LMP_PAIR_TABLE_Orientation_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_Orientation : public Pair {
 public:
  PairTable_Orientation(class LAMMPS *);
  virtual ~PairTable_Orientation();
