    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      for (kk = 0; kk < jnum; kk++) {
        ...
        if (k != j){
          ...
          if (rsq2 < params[ikparam].cutsq * 0.25){
          ...
          if ((rsq3 < params[ikparam].cutsq * 0.25) && (jj < kk)){ // this is j,k are both i's neighbor
            ...
            threebody2(&params[ijparam1],&params[ikparam1],&params[ijkparam1],
...
void PairSW_NT::threebody2(Param *paramij, Param *paramik, Param *paramijk,
                       double rsq1, double rsq2,
                       double *delr1, double *delr2,
                       double *fj, double *fk, int eflag, double &eng)
{
