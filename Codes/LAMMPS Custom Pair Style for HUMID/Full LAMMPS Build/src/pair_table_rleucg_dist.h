...
PairStyle(table_rleucg_dist,PairTable_RLEUCG_DIST)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_DIST_H
#define LMP_PAIR_TABLE_RLEUCG_DIST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_DIST : public Pair {
 public:
  PairTable_RLEUCG_DIST(class LAMMPS *);
  virtual ~PairTable_RLEUCG_DIST();
