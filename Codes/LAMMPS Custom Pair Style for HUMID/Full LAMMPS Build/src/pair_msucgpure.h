...
PairStyle(msucgpure,PairMSUCGPure)

#else

#ifndef LMP_PAIR_MSUCGPURE_H
#define LMP_PAIR_MSUCGPURE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCGPure : public Pair {
 public:
  PairMSUCGPure(class LAMMPS *);
  virtual ~PairMSUCGPure();
