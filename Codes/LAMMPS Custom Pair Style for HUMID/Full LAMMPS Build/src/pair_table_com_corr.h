...
PairStyle(table_com_corr,PairTable_com_corr)

#else

#ifndef LMP_PAIR_TABLE_COM_CORR_H
#define LMP_PAIR_TABLE_COM_CORR_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_com_corr : public Pair {
 public:
  PairTable_com_corr(class LAMMPS *);
  virtual ~PairTable_com_corr();
