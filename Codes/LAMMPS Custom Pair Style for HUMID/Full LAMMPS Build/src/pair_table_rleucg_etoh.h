...
PairStyle(table_rleucg_etoh,PairTable_RLEUCG_ETOH)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_ETOH_H
#define LMP_PAIR_TABLE_RLEUCG_ETOH_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_ETOH : public Pair {
 public:
  PairTable_RLEUCG_ETOH(class LAMMPS *);
  virtual ~PairTable_RLEUCG_ETOH();
