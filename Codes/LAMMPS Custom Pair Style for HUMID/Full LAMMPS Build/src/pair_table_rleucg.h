...
PairStyle(table_rleucg,PairTable_RLEUCG)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_H
#define LMP_PAIR_TABLE_RLEUCG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG : public Pair {
 public:
  PairTable_RLEUCG(class LAMMPS *);
  virtual ~PairTable_RLEUCG();
