...
PairMSUCG_NEIGHCK::PairMSUCG_NEIGHCK(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
  countiter = 0;
...
PairMSUCG_NEIGHCK::~PairMSUCG_NEIGHCK()
{
  if (allocated) {
...
void PairMSUCG_NEIGHCK::threshold_prob_and_partial_from_cv(int type, double cv, double &prob, double &partial) {
...
int PairMSUCG_NEIGHCK::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGHCK::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairMSUCG_NEIGHCK::pack_forward_comm(int n, int *list, double *buf,
...
void PairMSUCG_NEIGHCK::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairMSUCG_NEIGHCK::compute(int eflag, int vflag)
{
...
void PairMSUCG_NEIGHCK::compute_inner()
{
...
void PairMSUCG_NEIGHCK::compute_middle()
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGHCK::compute_outer(int eflag, int vflag)
{
  error->all(FLERR, "Work not done here!"); /*---YP--- Haven't done this part yet */
...
void PairMSUCG_NEIGHCK::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairMSUCG_NEIGHCK::settings(int narg, char **arg)
{
...
void PairMSUCG_NEIGHCK::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
void PairMSUCG_NEIGHCK::init_style()
{
...
void PairMSUCG_NEIGHCK::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairMSUCG_NEIGHCK::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairMSUCG_NEIGHCK::write_restart(FILE *fp)
{
...
void PairMSUCG_NEIGHCK::read_restart(FILE *fp)
{
...
void PairMSUCG_NEIGHCK::write_restart_settings(FILE *fp)
{
...
void PairMSUCG_NEIGHCK::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairMSUCG_NEIGHCK::write_data(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
void PairMSUCG_NEIGHCK::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairMSUCG_NEIGHCK::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairMSUCG_NEIGHCK::extract(const char *str, int &dim)
{
  dim = 2;
