...
PairStyle(msucg_1d_new,PairMSUCG_1D_NEW)

#else

#ifndef LMP_PAIR_MSUCG_1D_NEW_H
#define LMP_PAIR_MSUCG_1D_NEW_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_1D_NEW : public Pair {
 public:
  PairMSUCG_1D_NEW(class LAMMPS *);
  virtual ~PairMSUCG_1D_NEW();
