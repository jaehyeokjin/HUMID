...
PairStyle(table_msucg_neo,PairTable_MSUCG_NEO)

#else

#ifndef LMP_PAIR_TABLE_MSUCG_NEO_H
#define LMP_PAIR_TABLE_MSUCG_NEO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_MSUCG_NEO : public Pair {
 public:
  PairTable_MSUCG_NEO(class LAMMPS *);
  virtual ~PairTable_MSUCG_NEO();
 ...
 protected:
  ...
  // MSUCG_NEO functions and variables
