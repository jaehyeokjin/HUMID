...
PairStyle(msucg_2d,PairMSUCG_2D)

#else

#ifndef LMP_PAIR_MSUCG_2D_H
#define LMP_PAIR_MSUCG_2D_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_2D : public Pair {
 public:
  PairMSUCG_2D(class LAMMPS *);
  virtual ~PairMSUCG_2D();
