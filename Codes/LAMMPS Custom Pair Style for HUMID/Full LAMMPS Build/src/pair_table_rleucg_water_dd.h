...
PairStyle(table_rleucg_water_dd,PairTable_RLEUCG_WATER_DD)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_WATER_DD_H
#define LMP_PAIR_TABLE_RLEUCG_WATER_DD_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_WATER_DD : public Pair {
 public:
  PairTable_RLEUCG_WATER_DD(class LAMMPS *);
  virtual ~PairTable_RLEUCG_WATER_DD();
 ...
 protected:
  ...
  double compute_proximity_function_inner(int, double);
  double compute_proximity_function_der_inner(int, double);
