...
PairStyle(table_rleucg_interface_trans,PairTable_RLEUCG_INTERFACE_TRANS)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_INTERFACE_TRANS_H
#define LMP_PAIR_TABLE_RLEUCG_INTERFACE_TRANS_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_INTERFACE_TRANS : public Pair {
 public:
  PairTable_RLEUCG_INTERFACE_TRANS(class LAMMPS *);
  virtual ~PairTable_RLEUCG_INTERFACE_TRANS();
