...
KSpaceStyle(pppm/electrode,PPPM_Electrode)
...
class PPPM_Electrode : public EVB_KSpace {
 public:
  PPPM_Electrode(class LAMMPS *, int, char **);
  virtual ~PPPM_Electrode();
  virtual void init();
  virtual void setup();
  void setup_grid();
...
------------------------------------------------------------------------- */
  ...
  class PairElectrode *pair_et;
  double *img1_rl, *img1_im, *img2_rl, *img2_im;  
  FFT_SCALAR *work1_img;
  int *greensfn_rev;
