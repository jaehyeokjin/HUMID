...
void EVB_PPPMELECTRODE::sci_compute_env(int vflag)
{
...
void EVB_PPPMELECTRODE::sci_setup_iteration()
{
...
void EVB_PPPMELECTRODE::sci_compute_cplx(int vflag)
{
...
void EVB_PPPMELECTRODE::sci_compute_exch(int vflag)
{
  off_diag_energy = 0.0;
...
void EVB_PPPMELECTRODE::sci_compute_eff(int vflag)
{
  ...
  // Restore effective charges to full values
...
void EVB_PPPMELECTRODE::sci_compute_eff_mp(int vflag)
{
  ...
  if(nw > 3) nw = 3;
  poisson_mp(vflag,iw,nw);

  // Only master partition calculates forces
  if(!evb_engine->mp_verlet_sci->is_master) {
...
void EVB_PPPMELECTRODE::sci_compute_eff_cplx(int vflag)
{
...
void EVB_PPPMELECTRODE::sci_compute_eff_cplx_mp(int vflag)
{
  TIMER_STAMP(EVB_PPPM, sci_compute_eff_cplx);
...
void EVB_PPPMELECTRODE::slabcorr_sci_cplx()
{
  ...
  energy += qqrd2e * e_slabcorr / comm->nprocs / et_factor / evb_engine->ncomplex;
}

void EVB_PPPMELECTRODE::slabcorr_sci_eff()
{
  // compute local cplx contribution to global dipole moment
...
void EVB_PPPMELECTRODE::poisson_mp(int vflag, int iw, int nw)
{
...
void EVB_PPPMELECTRODE::poisson_ik_mp(int vflag, int iw, int nw)
{
  int i,j,k,n;
  double eng;
