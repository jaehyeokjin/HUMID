...
PairStyle(table_rleucg_meohwat,PairTable_RLEUCG_MEOHWAT)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_MEOHWAT_H
#define LMP_PAIR_TABLE_RLEUCG_MEOHWAT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_MEOHWAT : public Pair {
 public:
  PairTable_RLEUCG_MEOHWAT(class LAMMPS *);
  virtual ~PairTable_RLEUCG_MEOHWAT();
