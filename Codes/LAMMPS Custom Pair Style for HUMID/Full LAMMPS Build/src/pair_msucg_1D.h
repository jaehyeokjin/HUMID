...
PairStyle(msucg_1d,PairMSUCG_1D)

#else

#ifndef LMP_PAIR_MSUCG_1D_H
#define LMP_PAIR_MSUCG_1D_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_1D : public Pair {
 public:
  PairMSUCG_1D(class LAMMPS *);
  virtual ~PairMSUCG_1D();
