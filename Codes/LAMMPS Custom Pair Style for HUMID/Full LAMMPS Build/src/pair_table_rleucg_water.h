...
PairStyle(table_rleucg_water,PairTable_RLEUCG_WATER)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_WATER_H
#define LMP_PAIR_TABLE_RLEUCG_WATER_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_WATER : public Pair {
 public:
  PairTable_RLEUCG_WATER(class LAMMPS *);
  virtual ~PairTable_RLEUCG_WATER();
 ...
 protected:
  ...
  double calc_qn_complex(double, double, double, double, double, double);
