...
PairTable_RLEUCG_INTERFACE_TRANS::PairTable_RLEUCG_INTERFACE_TRANS(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
  // From PAIR_RLEUCG_INTERFACE_TRANS_NEIGH
  nmax = 0;
...
PairTable_RLEUCG_INTERFACE_TRANS::~PairTable_RLEUCG_INTERFACE_TRANS()
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::threshold_prob_and_partial_from_cv(int type, double cv, double &prob, double &partial) 
{
  if (type == 1){
    double tanh_factor = tanh((cv - cv_thresholds[type]) / (0.125 * cv_thresholds[type]));
    prob = 0.5 + 0.5 * tanh_factor;
    partial = 0.5 * (1.0 - tanh_factor * tanh_factor) / (0.125 * cv_thresholds[type]);
  }
  else {
...
int PairTable_RLEUCG_INTERFACE_TRANS::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairTable_RLEUCG_INTERFACE_TRANS::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
int PairTable_RLEUCG_INTERFACE_TRANS::pack_forward_comm(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
  int i,j,m,jsubstate;
...
void PairTable_RLEUCG_INTERFACE_TRANS::unpack_forward_comm(int n, int first, double *buf)
{
...
double PairTable_RLEUCG_INTERFACE_TRANS::compute_proximity_function(int type, double distance) {
  double tanh_factor = tanh((distance - threshold_radii[type]) / (0.1 * threshold_radii[type]));
  return 0.5 * (1.0 - tanh_factor);
}

double PairTable_RLEUCG_INTERFACE_TRANS::compute_proximity_function_der(int type, double distance) {
  double tanh_factor = tanh((distance - threshold_radii[type]) / (0.1 * threshold_radii[type]));
...
void PairTable_RLEUCG_INTERFACE_TRANS::compute(int eflag, int vflag)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::allocate()
{
  allocated = 1;
...
void PairTable_RLEUCG_INTERFACE_TRANS::settings(int narg, char **arg)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::read_state_settings(const char *file) {
  char *eof;
  char line[MAXLINE];
...
void PairTable_RLEUCG_INTERFACE_TRANS::coeff(int narg, char **arg)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::init_style()
{
...
double PairTable_RLEUCG_INTERFACE_TRANS::init_one(int i, int j)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairTable_RLEUCG_INTERFACE_TRANS::bcast_table(Table *tb)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::spline_table(Table *tb)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairTable_RLEUCG_INTERFACE_TRANS::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairTable_RLEUCG_INTERFACE_TRANS::null_table(Table *tb)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::free_table(Table *tb)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::spline(double *x, double *y, int n,
...
double PairTable_RLEUCG_INTERFACE_TRANS::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairTable_RLEUCG_INTERFACE_TRANS::write_restart(FILE *fp)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::read_restart(FILE *fp)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::write_restart_settings(FILE *fp)
{
...
void PairTable_RLEUCG_INTERFACE_TRANS::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairTable_RLEUCG_INTERFACE_TRANS::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairTable_RLEUCG_INTERFACE_TRANS::extract(const char *str, int &dim)
{
