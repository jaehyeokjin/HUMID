...
PairStyle(msucg_mix1dz,PairMSUCG_MIX1DZ)

#else

#ifndef LMP_PAIR_MSUCG_MIX1DZ_H
#define LMP_PAIR_MSUCG_MIX1DZ_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMSUCG_MIX1DZ : public Pair {
 public:
  PairMSUCG_MIX1DZ(class LAMMPS *);
  virtual ~PairMSUCG_MIX1DZ();
