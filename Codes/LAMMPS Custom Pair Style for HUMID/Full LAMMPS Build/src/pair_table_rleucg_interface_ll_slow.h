...
PairStyle(table_rleucg_interface_ll_slow,PairTable_RLEUCG_INTERFACE_LL_SLOW)

#else

#ifndef LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_SLOW_H
#define LMP_PAIR_TABLE_RLEUCG_INTERFACE_LL_SLOW_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_RLEUCG_INTERFACE_LL_SLOW : public Pair {
 public:
  PairTable_RLEUCG_INTERFACE_LL_SLOW(class LAMMPS *);
  virtual ~PairTable_RLEUCG_INTERFACE_LL_SLOW();
