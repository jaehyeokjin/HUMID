...
PairStyle(table_ucg_hydronium,PairTable_UCG_HYDRONIUM)

#else

#ifndef LMP_PAIR_TABLE_UCG_HYDRONIUM_H
#define LMP_PAIR_TABLE_UCG_HYDRONIUM_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTable_UCG_HYDRONIUM : public Pair {
 public:
  PairTable_UCG_HYDRONIUM(class LAMMPS *);
  virtual ~PairTable_UCG_HYDRONIUM();
