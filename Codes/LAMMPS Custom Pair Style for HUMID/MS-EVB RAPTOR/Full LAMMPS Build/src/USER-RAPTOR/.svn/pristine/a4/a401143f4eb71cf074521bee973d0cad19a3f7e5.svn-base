...
void EVB_Complex::update_pair_list_omp()
{
  ...
  const int inum = force->pair->list->inum;
  const int * const ilist = force->pair->list->ilist;
  const int * const numneigh = force->pair->list->numneigh;
  int * const * const firstneigh = force->pair->list->firstneigh;
